...
public:
   ...
   void onTransIOBInsns (ExecutionSignal* signal, S2EExecutionState* state, uint64_t pc, TranslationBlock* tb);
   ...
   /* A type of a signal emitted on instruction execution. Instances of this signal
    w ill be dynamically created and destroyed on demand during translation. 
    typedef sigc::signal<void, S2EExecutionState* state, uint64_t pc > ExecutionSignal;*/
