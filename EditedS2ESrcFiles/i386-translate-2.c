...
#include "cpu.h"
#include "exec-all.h"
//#include "/home/s2e/s2e/dasos/s2e/s2e/qemu/exec-all.h" // RJF I was having some #define problems
#include "disas.h"
#include "tcg-op.h"
...
// start RJF
static inline void gen_op_st_v_RJF (struct TranslationBlock* tb, int idx, TCGvt0, TCGv a0) {
   int mem_index = (idx >> 2) - 1;
   switch(idx & 3) {
      case 0:
         tb->write_len = 1;
   ...
   //static inline void tcg_gen_qemu_st8(TCGv arg (t0), TCGv addr (a0), int mem_index)
   // tcg_gen_op3i_i32(INDEX_op_qemu_st8, arg, addr, mem_index);
   //static inline void tcg_gen_op3i_i32(int opc, TCGv_i32 arg1, TCGv_i32 arg2, TCGArg arg3)
   /*   *gen_opparam_ptr++ = GET_TCGV_I32(arg1);
      *gen_opparam_ptr++ = GET_TCGV_I32(arg2);
      *gen_opparam_ptr++ = arg3;*/
   
   tb->write_addr = a0;
   gen_op_st_v(idx, t0, a0);
} // end RJF
